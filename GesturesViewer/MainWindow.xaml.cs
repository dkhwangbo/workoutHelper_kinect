...
namespace GesturesViewer
{
    ...
    public partial class MainWindow
    {
        ...
        TemplatedGestureDetector goRecognizer;
        TemplatedGestureDetector eatRecognizer;
        ...
        {
            circleKBPath = Path.Combine(Environment.CurrentDirectory, @"data\hi.save");
            goKBPath = Path.Combine(Environment.CurrentDirectory, @"data\goKB.save");
            letterT_KBPath = Path.Combine(Environment.CurrentDirectory, @"data\t_KB.save");
            eatPath = Path.Combine(Environment.CurrentDirectory, @"data\fun.save");
        ...
        private void Initialize()
        {
            ...
            parallelCombinedGestureDetector.Add(eatRecognizer);
            parallelCombinedGestureDetector.Add(goRecognizer);
            ...
            foreach (var skeleton in frame.Skeletons)
            {
                ...
                foreach (Joint joint in skeleton.Joints)
                {
                    ...
                    if (joint.JointType == JointType.HandRight)
                    {
                        ...
                        goRecognizer.Add(joint.Position, kinectSensor);
                        eatRecognizer.Add(joint.Position, kinectSensor);
                    }
        ...
        private void Clean()
        {
            ...
            if (parallelCombinedGestureDetector != null)
            {
                ...
                parallelCombinedGestureDetector.Remove(goRecognizer);
                parallelCombinedGestureDetector.Remove(eatRecognizer);
